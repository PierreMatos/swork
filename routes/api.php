...
Route::middleware('auth:api')->group(function(){
    ...
    Route::GET('received_messages', 'App\Http\Controllers\API\UserAPIController@getMessagesReceived');
    Route::GET('sent_messages', 'App\Http\Controllers\API\UserAPIController@getMessagesSent');
